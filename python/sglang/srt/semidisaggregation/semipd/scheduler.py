...
class SemiPDScheduler(Scheduler, SchedulerSemiPDMixin):
    ...
    def add_to_waiting_queue(self, req: Req):
        ...
        logging.info(f"add to waiting queue: {req.rid}")
...
class SemiPDPrefillScheduler(SemiPDScheduler):
    ...
    #     else:
    #         self.waiting_queue.append(req)
    #     logging.info(f"prefill add to waiting queue: {req.rid}")
    ...
    def get_next_batch_to_run(self) -> Optional[ScheduleBatch]:
        resp = None
        # logging.info("prefill get next batch to run")
...
class SemiPDDecodeScheduler(SemiPDScheduler):
    ...
    #     else:
    #         self.waiting_queue.append(req)
    #     logging.info(f"decode add to waiting queue: {req.rid}")
    ...
    def process_prefill_result(self, recv_req: BatchProcessPrefillResultReq):
        ...
        logging.info(f"recv prefill results {recv_req.next_token_ids}")
